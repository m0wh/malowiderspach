...
},{"gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"src/modules/distorsion-hover.js":[function(require,module,exports) {
...
/*#__PURE__*/
function () {
  function Menu(SVGSelector, menuSelector, itemSelector) {
    var _this = this;
    ...
    this.DOM.imgs = _toConsumableArray(this.DOM.svg.querySelectorAll('g > image')); // The menu links

    this.DOM.menuLinks = _toConsumableArray(this.DOM.menu.querySelectorAll(itemSelector)); // Mouse position
    ...
    this.dmScale = 0; // Current menu link position
  ...
  _createClass(Menu, [{
    ...
    value: function initEvents() {
      ...
      this.DOM.menuLinks.forEach(function (item, pos) {
        var mouseenterFn = function mouseenterFn() {
          ...
          _this2.current = pos; // Now fade in the new image if we are entering the menu or just set the new image's opacity to 1 if switching between menu items.

          if (_this2.fade) {
            TweenMax.to(_this2.DOM.imgs[_this2.current], 0.5, {
              ease: Quad.easeOut,
              opacity: 1
            });
            _this2.fade = false;
    ...
    value: function render() {
      ...
      this.DOM.svg.style.transform = "translate3d(".concat(this.lastMousePos.translation.x - this.DOM.svg.attributes["width"].nodeValue / 2, "px, ").concat(this.lastMousePos.translation.y - this.DOM.svg.attributes["height"].nodeValue / 2, "px, 0)"); // Scale goes from 0 to 50 for mouseDistance values between 0 to 140
...
},{}],"node_modules/graphql-request/dist/src/types.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/graphql-request/dist/src/index.js":[function(require,module,exports) {
"use strict";
...
},{"./types":"node_modules/graphql-request/dist/src/types.js","cross-fetch/polyfill":"node_modules/cross-fetch/dist/browser-polyfill.js"}],"src/modules/data.js":[function(require,module,exports) {
"use strict";

var _graphqlRequest = require("graphql-request");

// https://api.mowh.fr/playground
var url = "https://api.mowh.fr/";

var getProjects = function getProjects() {
  var query = "{\n    getUser(username: \"mowh\") {\n      projects {\n        name\n        description\n        url\n        covers {\n          size\n          src\n        }\n      }\n    }\n  }";
  return (0, _graphqlRequest.request)(url, query).then(function (data) {
    return data.getUser.projects.map(function (project) {
      return {
        name: project.name,
        description: project.description,
        url: project.url,
        cover: project.covers.filter(function (_ref) {
          var size = _ref.size;
...
},{"graphql-request":"node_modules/graphql-request/dist/src/index.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./assets\\fonts\\manrope-extrabold.woff2":[["manrope-extrabold.1d682e25.woff2","src/assets/fonts/manrope-extrabold.woff2"],"src/assets/fonts/manrope-extrabold.woff2"],"./assets\\fonts\\manrope-extrabold.woff":[["manrope-extrabold.e946383f.woff","src/assets/fonts/manrope-extrabold.woff"],"src/assets/fonts/manrope-extrabold.woff"],"./assets\\fonts\\manrope-extrabold.otf":[["manrope-extrabold.0f05658b.otf","src/assets/fonts/manrope-extrabold.otf"],"src/assets/fonts/manrope-extrabold.otf"],"./assets\\fonts\\manrope-bold.woff2":[["manrope-bold.498ef638.woff2","src/assets/fonts/manrope-bold.woff2"],"src/assets/fonts/manrope-bold.woff2"],"./assets\\fonts\\manrope-bold.woff":[["manrope-bold.2e42881a.woff","src/assets/fonts/manrope-bold.woff"],"src/assets/fonts/manrope-bold.woff"],"./assets\\fonts\\manrope-bold.otf":[["manrope-bold.5401b32f.otf","src/assets/fonts/manrope-bold.otf"],"src/assets/fonts/manrope-bold.otf"],"./assets\\fonts\\manrope-semibold.woff2":[["manrope-semibold.4962abe0.woff2","src/assets/fonts/manrope-semibold.woff2"],"src/assets/fonts/manrope-semibold.woff2"],"./assets\\fonts\\manrope-semibold.woff":[["manrope-semibold.0240b14c.woff","src/assets/fonts/manrope-semibold.woff"],"src/assets/fonts/manrope-semibold.woff"],"./assets\\fonts\\manrope-semibold.otf":[["manrope-semibold.60ff9e9e.otf","src/assets/fonts/manrope-semibold.otf"],"src/assets/fonts/manrope-semibold.otf"],"./assets\\fonts\\manrope-medium.woff2":[["manrope-medium.321f248d.woff2","src/assets/fonts/manrope-medium.woff2"],"src/assets/fonts/manrope-medium.woff2"],"./assets\\fonts\\manrope-medium.woff":[["manrope-medium.62a45712.woff","src/assets/fonts/manrope-medium.woff"],"src/assets/fonts/manrope-medium.woff"],"./assets\\fonts\\manrope-medium.otf":[["manrope-medium.c32c399d.otf","src/assets/fonts/manrope-medium.otf"],"src/assets/fonts/manrope-medium.otf"],"./assets\\fonts\\manrope-regular.woff2":[["manrope-regular.0ffe81bb.woff2","src/assets/fonts/manrope-regular.woff2"],"src/assets/fonts/manrope-regular.woff2"],"./assets\\fonts\\manrope-regular.woff":[["manrope-regular.37b5d2bb.woff","src/assets/fonts/manrope-regular.woff"],"src/assets/fonts/manrope-regular.woff"],"./assets\\fonts\\manrope-regular.otf":[["manrope-regular.f2fe2dba.otf","src/assets/fonts/manrope-regular.otf"],"src/assets/fonts/manrope-regular.otf"],"./assets\\fonts\\manrope-light.woff2":[["manrope-light.18378f8b.woff2","src/assets/fonts/manrope-light.woff2"],"src/assets/fonts/manrope-light.woff2"],"./assets\\fonts\\manrope-light.woff":[["manrope-light.7335e5e5.woff","src/assets/fonts/manrope-light.woff"],"src/assets/fonts/manrope-light.woff"],"./assets\\fonts\\manrope-light.otf":[["manrope-light.74fd8c7b.otf","src/assets/fonts/manrope-light.otf"],"src/assets/fonts/manrope-light.otf"],"./assets\\fonts\\manrope-thin.woff2":[["manrope-thin.05061ded.woff2","src/assets/fonts/manrope-thin.woff2"],"src/assets/fonts/manrope-thin.woff2"],"./assets\\fonts\\manrope-thin.woff":[["manrope-thin.2337eee7.woff","src/assets/fonts/manrope-thin.woff"],"src/assets/fonts/manrope-thin.woff"],"./assets\\fonts\\manrope-thin.otf":[["manrope-thin.d807f3a1.otf","src/assets/fonts/manrope-thin.otf"],"src/assets/fonts/manrope-thin.otf"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var _distorsionHover = require("./modules/distorsion-hover");
...
setInterval(function () {
  ...
  var scrollSpeed = currentScroll - oldScroll;
  ...
  document.querySelector("header .logo").style.transform = "scale3d(1, ".concat(1 + Math.abs(scrollSpeed) / 400, ", 1) skewY(").concat(-scrollSpeed / 10, "deg)");
...
(0, _data.getProjects)().then(function (projects) {
  return projects.forEach(function (project) {
    ...
    li.innerHTML = "<a href=\"".concat(project.url, "\" target=\"_blank\" class=\"project__desc\"><span class=\"project__name\">").concat(project.name, " \u2014</span> ").concat(project.description, " <span class=\"arrow\">-></span></a>"); // add it the "project" class

    projectsList.appendChild(li); // append it to the list element

    coversList.innerHTML += "<image class=\"distort__cover\" x=\"0\" y=\"0\" xlink:href=\"".concat(project.cover, "\" height=\"632\" width=\"808\" />"); // ScrollMagic & GSAP
