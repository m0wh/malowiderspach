...
(0, _data.getProjects)().then(function (projects) {
  return projects.forEach(function (project) {
    ...
    li.innerHTML = "<a href=\"".concat(project.url, "\" target=\"_blank\" class=\"project__desc\"><span class=\"project__name\">").concat(project.name, " \u2014</span> ").concat(project.description, " <span class=\"arrow\">-></span></a>");
